...
import { mulberry32, Prng } from '../../../shared/fixtures/random'
import {
  IDLE_TURN,
...
// The PRNG lives in the shared fixtures package so the fixture factories and
// this harness draw their determinism from one implementation.
export { mulberry32, Prng }
